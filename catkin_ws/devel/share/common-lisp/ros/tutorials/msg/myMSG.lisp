...
(cl:defmethod cl:initialize-instance :after ((m <myMSG>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'myMSG)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tutorials-msg:<myMSG> is deprecated: use tutorials-msg:myMSG instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <myMSG>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorials-msg:num-val is deprecated.  Use tutorials-msg:num instead.")
  (num m))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <myMSG>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorials-msg:first_name-val is deprecated.  Use tutorials-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <myMSG>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorials-msg:last_name-val is deprecated.  Use tutorials-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <myMSG>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorials-msg:age-val is deprecated.  Use tutorials-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <myMSG>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tutorials-msg:score-val is deprecated.  Use tutorials-msg:score instead.")
  (score m))
